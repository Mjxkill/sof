...
P_GRAPH(pipe-passthrough-capture, PIPELINE_ID,
	LIST(`		',
...
PCM_CAPABILITIES(Passthrough Capture PCM_ID, COMP_FORMAT_NAME(PIPELINE_FORMAT), PCM_MIN_RATE, PCM_MAX_RATE, LOCAL_CHANNELS_MIN, PIPELINE_CHANNELS, 2, 16, 24576, 24576, 49152, 98304)
