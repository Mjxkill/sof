...
# Host "DRC Capture" PCM
# with 0 sink and 3 source periods
W_PCM_CAPTURE(PCM_ID, DRC Capture, 0, 3, SCHEDULE_CORE)
...
P_GRAPH(pipe-drc-capture, PIPELINE_ID,
	LIST(`		',
...
indir(`define', concat(`PIPELINE_PCM_', PIPELINE_ID), DRC Capture PCM_ID)

#
# PCM Configuration
#

PCM_CAPABILITIES(DRC Capture PCM_ID, CAPABILITY_FORMAT_NAME(PIPELINE_FORMAT),
