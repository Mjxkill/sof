...
# 8-channel TDM : DRC on capture, passthrough on playback, 8ms DMA
#
...
# Capture pipeline with DRC, 8ms DMA
PIPELINE_PCM_ADD(sof/pipe-drc-enabled-capture.m4,
	1, 0, 8, s32le,
	8000, 0, 0,
	48000, 48000, 48000)

# Playback pipeline passthrough, 8ms DMA
...
DAI_ADD(sof/pipe-dai-capture.m4,
	...
	8000, 0, 0, SCHEDULE_TIME_DOMAIN_DMA)
